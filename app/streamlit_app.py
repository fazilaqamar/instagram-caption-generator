...
with tab1:
    ...
    custom_instruction = st.text_area(
        ...
        placeholder="e.g., Make it about summer vibes, include a pun, or reference pop culture...",
        height=60
    )
        ...
        with st.spinner("🎨 Cooking up some fire captions..."):
            try:
                ...
                if captions:
                    # Generate hashtags
                    style_hashtags = {
                        "funny": ["#LOL", "#Funny", "#Meme"],
                        "luxury": ["#Luxury", "#HighEnd", "#Exclusive"],
                        "motivational": ["#Motivation", "#Success", "#Grind"],
                        "aesthetic": ["#Aesthetic", "#Vibes", "#Dreamy"],
                        "bold": ["#Bold", "#Fearless", "#Boss"],
                        "emotional": ["#Feelings", "#Heartfelt", "#Deep"],
                        "savage": ["#Savage", "#Unbothered", "#Queen"],
                        "relatable": ["#Relatable", "#Mood", "#RealTalk"],
                        "poetic": ["#Poetry", "#Art", "#Words"],
                        "witty": ["#Witty", "#Smart", "#Clever"],
                        "inspirational": ["#Inspire", "#Elevate", "#Positive"],
                        "vibes": ["#GoodVibes", "#Chill", "#Energy"]
                    }
                    
                    topic_hashtags = {
                        "cars": ["#CarLover", "#Speed", "#Auto"],
                        "travel": ["#Wanderlust", "#Explore", "#Adventure"],
                        "fashion": ["#OOTD", "#Style", "#Fashionista"],
                        "fitness": ["#FitLife", "#Gym", "#Workout"],
                        "food": ["#Foodie", "#Delicious", "#Yum"],
                        "nature": ["#NatureLover", "#Outdoors", "#Earth"],
                        "tech": ["#Tech", "#Innovation", "#Future"],
                        "beauty": ["#GlowUp", "#Skincare", "#SelfCare"],
                        "pets": ["#PetLover", "#FurryFriend", "#Cute"],
                        "music": ["#Music", "#Artist", "#Melody"],
                        "art": ["#Art", "#Creative", "#Artist"],
                        "photography": ["#Photography", "#Capture", "#Lens"],
                        "business": ["#Business", "#Success", "#CEO"],
                        "entrepreneur": ["#Entrepreneur", "#Hustle", "#Startup"],
                        "lifestyle": ["#Lifestyle", "#Daily", "#Life"],
                        "wellness": ["#Wellness", "#Health", "#Mindful"]
                    }
                    
                    final_hashtags = [f"#{topic}"]
                    final_hashtags.extend(style_hashtags.get(style, ["#Creative", "#Unique"]))
                    final_hashtags.extend(topic_hashtags.get(topic, ["#Instagram", "#Viral"]))
                    final_hashtags.extend(["#ContentCreator", "#Trending", "#FYP"])
                    final_hashtags = list(dict.fromkeys(final_hashtags))[:12]
                    hashtags_text = " ".join(final_hashtags)
